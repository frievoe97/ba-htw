...
from viz_utils import read_csv, aggregate_data, remove_constant_columns, \
    aggregate_correct_percent_by_parameters, determine_group_columns, print_full_df, measurements_per_room

# Einheitliche Schriftgröße definieren
...
def plot_line_charts(cleaned_data):
    ...
    # fig.suptitle('Correct Percent by Algorithm, Room Count, and Algorithm Value', fontsize=16)
...
def plot_combined_line_charts(cleaned_data):
    ...
    fig, axes = plt.subplots(2, 2, figsize=(18, 10))
    # fig.suptitle('Correct Percent by Value Scaling Strategy, Algorithm, and Weights', fontsize=16)
